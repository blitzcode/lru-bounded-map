...
main = do
    ...
    (keysL          ) `deepseq`
      ...
      defaultMainWith
        ...
        , bgroup ("lookup (w/ LRU update, ordered keys) " ++ numK)
          [
        ...
        , bgroup ("lookup (w/ LRU update) " ++ numK)
          [
            lkBench "LBM_LinkedListHashMap (limit 5k)" (LBM_LLHM.lookup)  lLBM_LLHM5k keysLShuffled
          , lkBench "LBM_LinkedListHashMap (limit 1k)" (LBM_LLHM.lookup)  lLBM_LLHM1k keysLShuffled
          , lkBench "LBM_DoubleMapBTree (limit 5k)"    (LBM_DMBT.lookup)  lLBM_DMBT5k keysLShuffled
          , lkBench "LBM_DoubleMapBTree (limit 1k)"    (LBM_DMBT.lookup)  lLBM_DMBT1k keysLShuffled
        --, lkBench "LBM_CustomHAMT (limit 5k)"        (LBM_CHAMT.lookup) lLBM_CHAMT5k keysLShuffled
        --, lkBench "LBM_CustomHAMT (limit 1k)"        (LBM_CHAMT.lookup) lLBM_CHAMT1k keysLShuffled
          , lkBench "LBM_CustomHashedTrie (limit 5k)"  (LBM_CHT.lookup)   lLBM_CHT5k  keysLShuffled
          , lkBench "LBM_CustomHashedTrie (limit 1k)"  (LBM_CHT.lookup)   lLBM_CHT1k  keysLShuffled
          ]
        ]
